...
class SwinTransformer(nn.Module):
    ...
    def __init__(
        ...
        # features head
        num_patches = self.forward_features(torch.rand(1, 3, img_size[0], img_size[1])).shape[1:3]
...
def _swin_transformer(
    ...
    # vit = VisionTransformer(img_size=112, patch_size=8, num_classes=512, embed_dim=512, depth=12,
    ...
    # x = x + vit.pos_embed
    # x = vit.pos_drop(x)
    # for func in vit.blocks:
    #     if vit.using_checkpoint and vit.training:
