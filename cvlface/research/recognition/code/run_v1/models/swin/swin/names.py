...
def swin_v2_s():
    return _swin_transformer(img_size=[112,112], patch_size=[4, 4], embed_dim=128, depths=[4, 6, 8], num_heads=[4, 8, 16],
                             window_size=[7, 7], stochastic_depth_prob=0.5, num_classes=512,
                             block=SwinTransformerBlockV2, downsample_layer=PatchMergingV2, )


def swin_v2_b():
    return _swin_transformer(img_size=[112,112], patch_size=[4, 4], embed_dim=256, depths=[4, 6, 8], num_heads=[4, 8, 16],
                             window_size=[7, 7], stochastic_depth_prob=0.5, num_classes=512,
                             block=SwinTransformerBlockV2, downsample_layer=PatchMergingV2, )
